...
public:
	Torso_Dialog() {
		dialog = new Fl_Window(340, 430, "Robot Torso");
		...
		torso_image = new Fl_Box(150, 280, 50, 50);
		Fl_PNG_Image *orange_torso = new Fl_PNG_Image("torso_orange.png");
		torso_image->image(orange_torso);

		t_create = new Fl_Return_Button(145, 400, 120, 25, "Create");
		t_create->callback((Fl_Callback *)create_torsoCB, 0);

		t_cancel = new Fl_Button(270, 400, 60, 25, "Cancel");
