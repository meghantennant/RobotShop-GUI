...
public:
	Arm_Dialog() {
		dialog = new Fl_Window(340, 350, "Robot Arm");
		...
		right_arm_image = new Fl_Box(50, 250, 50, 50);
		Fl_PNG_Image *arm_right_orange = new Fl_PNG_Image("arm_right_orange.png");
		right_arm_image->image(arm_right_orange);

		left_arm_image = new Fl_Box(200, 250, 50, 50);
		Fl_PNG_Image *arm_left_orange = new Fl_PNG_Image("arm_left_orange.png");
		left_arm_image->image(arm_left_orange);

		a_create = new Fl_Return_Button(145, 320, 120, 25, "Create");
		a_create->callback((Fl_Callback *)create_armCB, 0);

		a_cancel = new Fl_Button(270, 320, 60, 25, "Cancel");
...
private:
	...
	Fl_Box *right_arm_image;
	Fl_Box *left_arm_image;
